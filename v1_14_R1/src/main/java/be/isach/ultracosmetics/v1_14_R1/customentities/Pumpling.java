...
import be.isach.ultracosmetics.v1_14_R1.pets.CustomEntityPet;
...
public class Pumpling extends EntityZombie implements IPetCustomEntity {
    ...
    public void tick() {
        ...
        if (!isCustomEntity()) return;
        fireTicks = 0;
        UtilParticles.drawParticlesWithOffset(Particles.FLAME, 0.2f, 0.2f, 0.2f, ((Zombie) getBukkitEntity()).getEyeLocation(), 3);
