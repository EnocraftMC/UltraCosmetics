...
public class SubCommandToggle extends SubCommand {
    ...
    public SubCommandToggle(UltraCosmetics ultraCosmetics) {
        super("Toggles a cosmetic.", "ultracosmetics.command.toggle", "/uc toggle <player> <type> <cosmetic>", ultraCosmetics, "toggle");
    }
            ...
            try {
                ...
                if (other.getCosmetic(category) != null && other.getCosmetic(category).getType().getConfigName().equalsIgnoreCase(cosm)) {
                    ...
                    try {
                        ...
                        sender.sendMessage(MessageManager.getMessage("Prefix") + " §c§l/uc toggle <player> suit <suit type:suit piece>.");
                        return;
                    }
                } else {
                    other.removeCosmetic(category);
    ...
    public List<String> getTabCompleteSuggestion(CommandSender sender, String... args) {
        //uc toggle <player> <type> <cosmetic>
